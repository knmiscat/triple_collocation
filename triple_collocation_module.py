...
class TripColProcess:
    ...
    def solve(self, repr_err, precision):
        ...
        self.C[1][2] = self.C[1][2] - repr_err
        self.C[2][1] = self.C[2][1] - repr_err
        ...
        self.errvar[0] = self.C[0][0] - self.C[1][0]*self.C[2][0]/self.C[2][1] - repr_err  # error variance system 0
        self.errvar[1] = self.C[1][1] - self.C[1][0]*self.C[2][1]/self.C[2][0] - repr_err  # error variance system 1
        self.errvar[2] = self.C[2][2] - self.C[2][0]*self.C[2][1]/self.C[1][0] + repr_err  # error variance system 2
